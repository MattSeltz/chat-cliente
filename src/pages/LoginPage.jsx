...
export const LoginPage = () => (
  <div className="h-screen overflow-hidden pb-10">
    <h3 className="text-center font-serif font-semibold mt-3 text-xl">Login</h3>
    <div className="h-1/3 flex flex-col items-center gap-10 mt-10 max-w-lg mx-auto px-10">
      <InputComponent type={"email"}>Email</InputComponent>
      <InputComponent type={"password"}>Contraseña</InputComponent>
      <ButtonComponent bg={true}>INGRESAR</ButtonComponent>
    </div>
